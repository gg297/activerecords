...
//-------------------------Insert Record-----------------gg297
   echo "<h2>Insert One Record</h2>";
        $record = new todo();
        $record->owneremail="gg297@njit.edu";
        $record->ownerid=06;
...
$record->owneremail="gg297@njit.edu";
$record->ownerid="60";
$record->createddate="09-11-1990";
$record->duedate="09-11-1990";
$record->message="hi this is gandharva";
$record->isdone="1";
$record->save();
$record = todos::findAll();
echo "<h3>Record update with id: ".$id."</h3>";
